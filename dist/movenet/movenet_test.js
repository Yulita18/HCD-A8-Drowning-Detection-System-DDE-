...
jasmine_util_1.describeWithFlags('MoveNet video ', jasmine_util_1.BROWSER_ENVS, function () {
    ...
    it('test lightning.', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, test_util_3.loadVideo('pose_1.mp4', 30 /* fps */, callback, expected, model)];
                case 2:
                    // Synthetic video at 30FPS.
                    _a.sent();
