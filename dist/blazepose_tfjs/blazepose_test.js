...
jasmine_util_1.describeWithFlags('BlazePose', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('estimatePoses does not leak memory.', function () { return __awaiter(_this, void 0, void 0, function () {
        var startTensors, detector, input, beforeTensors;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    startTensors = tf.memory().numTensors;
                    return [4 /*yield*/, poseDetection.createDetector(poseDetection.SupportedModels.BlazePose, { runtime: 'tfjs' })];
                case 1:
                    detector = _a.sent();
    ...
    it('throws error when runtime is not set.', function (done) { return __awaiter(_this, void 0, void 0, function () {
        var e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
jasmine_util_1.describeWithFlags('BlazePose static image ', jasmine_util_1.BROWSER_ENVS, function () {
    ...
    it('test.', function () { return __awaiter(_this, void 0, void 0, function () {
        var startTensors, beforeTensors, result, xy, xyz;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    startTensors = tf.memory().numTensors;
                    return [4 /*yield*/, poseDetection.createDetector(poseDetection.SupportedModels.BlazePose, { runtime: 'tfjs', enableSmoothing: false })];
                case 1:
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch(test_util_2.KARMA_SERVER + "/pose_squats.full.json")
                            ...
                            .then(function (result) { return test_util_3.getXYPerFrame(result); })];
                case 1:
                    expected = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, test_util_3.loadVideo('pose_squats.mp4', 5 /* fps */, callback, expected, model)];
                case 2:
                    // Original video source in 720 * 1280 resolution:
                    // https://www.pexels.com/video/woman-doing-squats-4838220/ Video is
                    // compressed to be smaller with less frames (5fps), using below
