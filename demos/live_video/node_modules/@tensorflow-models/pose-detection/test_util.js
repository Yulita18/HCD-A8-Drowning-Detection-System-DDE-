...
var SIMULATED_INTERVAL = 33.333; // in milliseconds
function loadVideo(videoPath, videoFPS, callback, expected, model) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            source.src = test_util_1.KARMA_SERVER + "/" + videoPath;
            ...
            promise = new Promise(function (resolve, reject) {
                video.onseeked = function () { return __awaiter(_this, void 0, void 0, function () {
                    var poses, expectedKeypoints, nextTime;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
...
function drawSkeleton(keypoints, model, ctx, color) {
    ctx.fillStyle = color;
    ctx.strokeStyle = color;
    ctx.lineWidth = 2;
    var pairs = poseDetection.util.getAdjacentPairs(model);
...
function draw(keypoints, ctx, model, color) {
    ctx.fillStyle = color;
    ctx.strokeStyle = color;
